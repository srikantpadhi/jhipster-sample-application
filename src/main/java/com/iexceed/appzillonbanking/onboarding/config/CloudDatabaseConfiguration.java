...
@Configuration
@EnableMongoRepositories("com.iexceed.appzillonbanking.onboarding.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.iexceed.appzillonbanking.onboarding.config.dbmigrations");
